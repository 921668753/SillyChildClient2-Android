...
public class AirportDropOffPayOrderPresenter implements AirportDropOffPayOrderContract.Presenter {

    private AirportDropOffPayOrderContract.View mView;

    public AirportDropOffPayOrderPresenter(AirportDropOffPayOrderContract.View view) {
        mView = view;
