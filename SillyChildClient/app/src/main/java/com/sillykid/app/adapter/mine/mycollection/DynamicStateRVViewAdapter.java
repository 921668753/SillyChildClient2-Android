...
//        }
        ...
        helper.setText(R.id.tv_strategy, model.getName());

        GlideImageLoader.glideLoader(mContext, model.getThumbnail(), helper.getImageView(R.id.img_head), 0, R.mipmap.placeholderfigure);

        // helper.setText(R.id.tv_attentionNum, model.getBrand_name());
