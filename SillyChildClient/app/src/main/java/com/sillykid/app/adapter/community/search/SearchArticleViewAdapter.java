...
public class SearchArticleViewAdapter extends BGARecyclerViewAdapter<CommunityBean.DataBean.ResultBean> {

    public SearchArticleViewAdapter(RecyclerView recyclerView) {
        super(recyclerView, R.layout.item_mystrategy);
    }

    @Override
    protected void fillData(BGAViewHolderHelper helper, int position, CommunityBean.DataBean.ResultBean model) {
