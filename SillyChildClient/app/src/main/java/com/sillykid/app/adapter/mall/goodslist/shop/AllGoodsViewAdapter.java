...
import com.sillykid.app.entity.mall.goodslist.shop.AllGoodsBean.DataBean;
...
public class AllGoodsViewAdapter extends BGARecyclerViewAdapter<DataBean> {

    public AllGoodsViewAdapter(RecyclerView recyclerView) {
