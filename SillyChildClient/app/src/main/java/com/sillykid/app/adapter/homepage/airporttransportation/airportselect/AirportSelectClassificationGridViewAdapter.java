 ...
 * 城市选择分类---GridView
 */
public class AirportSelectClassificationGridViewAdapter extends BGAAdapterViewAdapter<DataBean> {


    public AirportSelectClassificationGridViewAdapter(Context context) {
