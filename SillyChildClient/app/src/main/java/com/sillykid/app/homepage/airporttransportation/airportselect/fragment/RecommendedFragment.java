...
import com.sillykid.app.adapter.homepage.airporttransportation.airportselect.fragment.RecommendedViewAdapter;
import com.sillykid.app.entity.homepage.airporttransportation.airportselect.fragment.RecommendedBean;
import com.sillykid.app.entity.homepage.airporttransportation.airportselect.fragment.RecommendedBean.DataBean;
 ...
 * 热门目的地
 */
public class RecommendedFragment extends BaseFragment implements AirportClassificationContract.View {

    private AirportSelectActivity aty;

    @BindView(id = R.id.tv_popularDestination)
    private TextView tv_popularDestination;
    ...
    protected void initWidget(View parentView) {
        ...
        tv_popularDestination.setText(getString(R.string.hitAirport));
