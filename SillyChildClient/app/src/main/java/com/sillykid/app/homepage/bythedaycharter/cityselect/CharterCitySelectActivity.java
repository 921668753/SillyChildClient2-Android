...
import com.sillykid.app.adapter.homepage.bythedaycharter.cityselect.CitySelectClassificationListViewAdapter;
 ...
 * 城市选择
 */
public class CharterCitySelectActivity extends BaseActivity implements CharterCitySelectContract.View, AdapterView.OnItemClickListener {
    ...
    public void initData() {
        super.initData();
        mPresenter = new CharterCitySelectPresenter(this);
        ...
        ((CharterCitySelectContract.Presenter) mPresenter).getCountryAreaList(type, 0);
    }
    ...
    @Override
    public void setPresenter(CharterCitySelectContract.Presenter presenter) {
