 ...
 * 社区分类列表
 */
public class CommunityClassificationFragment extends BaseFragment implements CommunityClassificationContract.View, BGARefreshLayout.BGARefreshLayoutDelegate, BGAOnRVItemClickListener {
